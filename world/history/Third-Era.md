...
**Cross-Reference:** `systems/gazes/Standard-Gazes.md` — Gaze of Seduction; `systems/gazes/Supreme-Gazes.md` — Supreme Gaze of Enchantment
...
**Cross-Reference:** `systems/arcane/Forbidden.md` — Shadow Magic (Deep Umbraturgy); The Veiled Operations (this section); `organizations/Organizations.md` — The Eternal Guard; The Umbra Shroud
...
**Cross-Reference:** `systems/gazes/Standard-Gazes.md` — Gaze of Torment, historical bearer section
...
**Cross-Reference:** `systems/gazes/Standard-Gazes.md` — Gaze of Revelation, historical bearer section
...
**Cross-Reference:** `systems/sigils/Standard-Sigils.md` — Dual Sigils; `organizations/Organizations.md` — House Dravenmore
