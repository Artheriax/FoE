...
**Cross-Reference:** `systems/sigils/Standard-Sigils.md` — Sigil of Vitality; `organizations/Organizations.md` — House Dravenmore
...
**Cross-Reference:** `systems/arcane/Holy-Unholy.md` — Luminancy Practitioners, Healer Cassian of the Ashenmoor; `organizations/Organizations.md` — House Dravenmore
...
**Cross-Reference:** `systems/arcane/Elemental.md` — Elemental Magic Practitioners: Glaciarch Frostweaver
...
**Cross-Reference:** `systems/gazes/Standard-Gazes.md` — Gaze of Harmony, historical bearer section
...
**Cross-Reference:** `systems/gazes/Standard-Gazes.md` — Gaze of Spirits, historical bearer section; `world/Dimensions.md` — Dreamveil
...
**Cross-Reference:** `systems/gazes/Standard-Gazes.md` — Gaze of Kinesis, historical bearer section
...
**Cross-Reference:** `systems/arcane/Forbidden.md` — Shadow Magic (Deep Umbraturgy); `organizations/Organizations.md` — The Eternal Guard; `world/Dimensions.md` — Dreamveil
...
**Cross-Reference:** `systems/gazes/Standard-Gazes.md` — Gaze of Destruction; `systems/gazes/Supreme-Gazes.md` — Supreme Gaze of Cataclysm, Case Origin documentation
