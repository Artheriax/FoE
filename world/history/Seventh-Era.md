...
**Cross-Reference:** `systems/sigils/Standard-Sigils.md` — Sigil of Fortitude
...
**Cross-Reference:** `systems/gazes/Standard-Gazes.md` — Gaze of Kinesis; `systems/gazes/Supreme-Gazes.md` — Supreme Gaze of Omnikinesis
...
**Cross-Reference:** `systems/arcane/Keystone.md` — Keystone Magic Practitioners, Archon Dravenmore; `systems/arcane/Forbidden.md` — Nil Space Magic; `world/Dimensions.md` — The Aether | Nil Space
...
**Cross-Reference:** `systems/gazes/Absolute-Gazes.md` — Absolute Gaze of Mindscape, Case Origin documentation; `organizations/Organizations.md` — The Eternal Guard
